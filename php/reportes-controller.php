...
class ReporteController {
    ...
    private function generarHTMLExcel($ofertas, $filtros) {
        ...
        $html .= '<thead style="background-color: #2E5090; color: white; font-weight: bold;">
            <tr>
                <th style="padding: 8px; border: 1px solid #000; text-align: center;">ID</th>
                <th style="padding: 8px; border: 1px solid #000;">Código</th>
                <th style="padding: 8px; border: 1px solid #000;">Carrera/Strand</th>
                <th style="padding: 8px; border: 1px solid #000; text-align: center;">Periodo</th>
                <th style="padding: 8px; border: 1px solid #000;">Asignatura</th>
                <th style="padding: 8px; border: 1px solid #000;">Docente</th>
                <th style="padding: 8px; border: 1px solid #000; text-align: center;">Sección</th>
                <th style="padding: 8px; border: 1px solid #000;">Horario</th>
                <th style="padding: 8px; border: 1px solid #000;">Aula</th>
                <th style="padding: 8px; border: 1px solid #000; text-align: center;">Cupos Disponibles</th>
                <th style="padding: 8px; border: 1px solid #000; text-align: center;">Cupos Ocupados</th>
                <th style="padding: 8px; border: 1px solid #000; text-align: center;">Cupos Totales</th>
                <th style="padding: 8px; border: 1px solid #000; text-align: center;">Estado</th>
                <th style="padding: 8px; border: 1px solid #000; text-align: center;">Fecha Creación</th>
            </tr>
        </thead>
        <tbody>';
...
>>>>>>> de08ae6e71e1063fcc012193ff9e823ec12bd75c
?>